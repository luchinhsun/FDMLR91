...
#define gna 23 // Max. Conductance of the Na Channel (mS/uF)
#define ena (((R*temp) / frdy)*log(nao / nai))
#define gk (0.282*sqrt(ko / 5.4))
#define gk1 (0.6047*(sqrt(ko / 5.4)))
#define gkp 0.0183
#define ek (((R*temp) / frdy)*log(ko / ki))
#define ek1 ek
#define ekp ek
