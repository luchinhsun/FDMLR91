...
__device__ void comp_it(double *d_V, double *d_m, double *d_h, double *d_jj,
                                 double *d_d, double *d_f, double *d_cai, double *dcai,
                                         double *d_X, double *d_it, double *d_m0, double *d_h0, double *d_jj0,
                                                double *d_d0, double *d_f0, double *d_X0, int I, int i, int k, double *d_t) {
	//int id = k+nx+2+1+2*j;
	d_it[k] = 0.0;
	...
	double Xi;
        if (d_V[k+nx+2+1+2*i] > -100) {
			...
			((d_V[k+nx+2+1+2*i] + 77)*exp(0.04*(d_V[k+nx+2+1+2*i] + 35)));
        }
        else {
                Xi = 1;
        }
	...
	//comp_ik1
        ...
        double ak1 = 1.02 / (1 + exp(0.2385*(d_V[k+nx+2+1+2*i] - ek1 - 59.215)));
        double bk1 = (0.49124*exp(0.08032*(d_V[k+nx+2+1+2*i] - ek1 + 5.476))+
	...
	//comp_ikp
        ...
        double kp = 1 / (1 + exp((7.488 - d_V[k+nx+2+1+2*i]) / 5.98));
...
__global__ void comp_dVdt(double *d_V, double *d_m, double *d_h, double *d_jj,
                                 double *d_d, double *d_f, double *d_cai, double *dcai,
                                         double *d_X, double *d_it, double *d_m0, double *d_h0, double *d_jj0,
                                                double *d_d0, double *d_f0, double *d_X0, double *d_dVdt, double *d_t){
...
__global__ void comp_ODE_stim(double *d_V, double *d_m, double *d_h, double *d_jj,
                                 double *d_d, double *d_f, double *d_cai, double *dcai,
                                         double *d_X, double *d_it, double *d_m0, double *d_h0, double *d_jj0,
                                                double *d_d0, double *d_f0, double *d_X0, double *d_dVdt, double *d_t){
...
__global__ void comp_ODE(double *d_V, double *d_m, double *d_h, double *d_jj,
                                 double *d_d, double *d_f, double *d_cai, double *dcai,
                                         double *d_X, double *d_it, double *d_m0, double *d_h0, double *d_jj0,
                                                double *d_d0, double *d_f0, double *d_X0, double *d_dVdt, double *d_t, int num){
